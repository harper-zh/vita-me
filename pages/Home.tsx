...
const Home: React.FC = () => {
  const [vitaminId, setVitaminId] = useState('');
  ...
  const locationData = {
    ...
    // 特别行政区
    '香港特别行政区': ['中西区', '湾仔区', '东区', '南区', '油尖旺区', '深水埗区', '九龙城区', '黄大仙区', '观塘区', '荃湾区', '屯门区', '元朗区', '北区', '大埔区', '沙田区', '西贡区', '离岛区', '葵青区'],
    '澳门特别行政区': ['澳门半岛', '氹仔', '路环'],
      ...
      >
        ...
        <section className="pb-12 pt-6 text-center space-y-8">
          ...
          {/* <div className="flex items-center justify-center">
            <div className="w-8 h-px bg-gradient-to-r from-transparent via-sage-300 to-transparent"></div>
            <Sparkles size={16} className="mx-4 text-sage-400" />
            <div className="w-8 h-px bg-gradient-to-r from-transparent via-sage-300 to-transparent"></div>
          </div> */}
